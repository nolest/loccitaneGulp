            ...
            <div class="ds-flex flex-v align-center clockColums">
                <div class="ds-flex align-center clockDived" v-for="(item,index) in week_clo">
                    ...
                    <div class="input-group date form_time manyInputCon">
                        <b-form-select v-model="nowEdit[index].defaultShopId" :options="editData[index].shopList" :value="nowEdit[index].shopValue" class="mb-3" :disabled="nowEdit[index].timeOut?true:false" :class="nowEdit[index].timeOut?'off':''"/>
                    </div>
                    <div class="input-group date form_time manyInputCon">
                        <b-form-select v-model="nowEdit[index].defaultRoster" :options="returnRoster(editData[index].shopList,nowEdit[index].defaultShopId)" class="mb-3" :disabled="nowEdit[index].timeOut?true:false" :class="nowEdit[index].timeOut?'off':''" @input="setRowTime(index,nowEdit[index].defaultRoster)"/>
                    </div>
                    <div class="input-group date form_time manyInputCon">
